// // ignore_for_file: use_build_context_synchronously, prefer_const_constructors, unused_field, prefer_const_constructors_in_immutables, prefer_const_literals_to_create_immutables
...
//     double relativeX = positionOffset.dx / _controller.value.size.width;
//     double relativeY = positionOffset.dy / _controller.value.size.height;

//     setState(() {
//       markers.add(Marker(
//         index: markers.length + 1,
//         position: positionInSeconds,
//         positionOffset: Offset(relativeX, relativeY), // Use relative positions
